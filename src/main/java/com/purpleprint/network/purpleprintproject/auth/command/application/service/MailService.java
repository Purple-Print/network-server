...
public class MailService {
    ...
    @Async
    public void sendEmailForMatchUsername(String toEmail, String username) throws MessagingException {
        ...
        helper.setSubject("[필로칼로] 아이디 찾기 안내");
        helper.setText("text/html","<!DOCTYPE html>\n" +
                "<html lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:o=\"urn:schemas-microsoft-com:office:office\">\n" +
                "<head>\n" +
                "  <meta charset=\"utf-8\">\n" +
                ...
                "            <tr>\n" +
                "              <td style=\"padding:30px;text-align:center;font-size:12px;background-color:#404040;color:#cccccc;\">\n" +
                "                <p style=\"margin:0;font-size:14px;line-height:20px;\">Copyright 2022. purpleprint all rights reserved.<br></p>\n" +
                "              </td>\n" +
                "            </tr>\n" +
                "          </table>\n" +
                "\n" +
    ...
    public void sendEmailForMatchPassword(String toEmail, String tempPassword) throws MessagingException {
        ...
        helper.setSubject("[필로칼로] 비밀번호 찾기 안내");
        helper.setText("text/html","<!DOCTYPE html>\n" +
                "<html lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\" xmlns:o=\"urn:schemas-microsoft-com:office:office\">\n" +
                "<head>\n" +
                "  <meta charset=\"utf-8\">\n" +
